...
// References:
// for refernces see readme 

public class FPSJFrameOld extends JPanel implements KeyListener, Runnable {
    ...
    public static void main(String[] args) {
        ...
        FPSJFrameOld game = new FPSJFrameOld();
